...
class Player:
    def __init__(self, food = 0, wood = 0, steel = 0, nuclear = 0, oil = 0, troops = 0, color = None):
        self.food = food
        self.wood = wood
        self.steel = steel
...
default_player = Player(color = (200,200,200))
...
def update_stats(active_player):
    active_player.troops = 0
    active_player.food = 0
    active_player.wood = 0
    active_player.steel = 0
    active_player.oil = 0
...
players = [Player( color = blue), Player( color = green), Player(color = red), Player(color=pink), Player(color=yellow), Player(color=white)]
...
#directories
folder = "/Users/hnootebos/Desktop/11General/Code/"
spr_nuclear = pg.image.load(f"{folder}/oil_board-backup_images/nuclear.png")
spr_nuclear.convert()
spr_food = pg.image.load(f"{folder}/oil_board-backup_images/food.png")
spr_food.convert()
spr_troops = pg.image.load(f"{folder}/oil_board-backup_images/troops.png")
spr_troops.convert()
spr_wood = pg.image.load(f"{folder}/oil_board-backup_images/wood.png")
spr_wood.convert()
spr_oil = pg.image.load(f"{folder}/oil_board-backup_images/oil.png")
spr_oil.convert()
spr_steel = pg.image.load(f"{folder}/oil_board-backup_images/steel.png")
spr_steel.convert()
spr_nuclear = pg.image.load(f"{folder}/oil_board-backup_images/nuclear.png")
spr_nuclear.convert()
spr_shop = pg.image.load(f"{folder}/oil_board-backup_images/shop.png")
spr_shop.convert()
spr_cards = pg.image.load(f"{folder}/oil_board-backup_images/cards.png")
spr_cards.convert()
spr_card0 = pg.image.load(f"{folder}/oil_board-backup_images/card0.png")
spr_card0.convert()
spr_card1 = pg.image.load(f"{folder}/oil_board-backup_images/card1.png")
spr_card1.convert()
spr_card2 = pg.image.load(f"{folder}/oil_board-backup_images/card2.png")
spr_card2.convert()
spr_bridge = pg.image.load(f"{folder}/oil_board-backup_images/bridge.png")
spr_bridge.convert()
spr_ship = pg.image.load(f"{folder}/oil_board-backup_images/ship.png")
spr_ship.convert()
spr_plane = pg.image.load(f"{folder}/oil_board-backup_images/plane.png")
spr_plane.convert()
spr_tank = pg.image.load(f"{folder}/oil_board-backup_images/tank.png")
spr_tank.convert()
spr_rails = pg.image.load(f"{folder}/oil_board-backup_images/rails.png")
spr_rails.convert()
spr_fort = pg.image.load(f"{folder}/oil_board-backup_images/fort.png")
spr_fort.convert()
spr_nuke = pg.image.load(f"{folder}/oil_board-backup_images/nuke.png")
spr_nuke.convert()
...
while running:
    ...
    if left_pressed:
        if transformed_mouse_position[0] > 0.65*WIDTH: #player switching
            for i, player in enumerate(players):
                if i < 3:
                    if pg.Rect(WIDTH - 200 + 1.1*i*BUTTON_WIDTH, 20, BUTTON_WIDTH, BUTTON_HEIGHT).collidepoint(mouse_position): #player is switched
    ...
    screen.blit(myfont.render("X " + str(active_player.troops), False, (0, 0, 0)), (WIDTH - 150, HEIGHT - 360))
    screen.blit(spr_food, (WIDTH - 200, HEIGHT - 320))
    screen.blit(myfont.render("X " + str(active_player.food), False, (0, 0, 0)), (WIDTH - 150, HEIGHT - 310))
    screen.blit(spr_wood, (WIDTH - 200, HEIGHT - 270))
    screen.blit(myfont.render("X " + str(active_player.wood), False, (0, 0, 0)), (WIDTH - 150, HEIGHT - 260))
    screen.blit(spr_steel, (WIDTH - 200, HEIGHT - 220))
    screen.blit(myfont.render("X " + str(active_player.steel), False, (0, 0, 0)), (WIDTH - 150, HEIGHT - 210))
    screen.blit(spr_oil, (WIDTH - 200, HEIGHT - 170))
    screen.blit(myfont.render("X " + str(active_player.oil), False, (0, 0, 0)), (WIDTH - 150, HEIGHT - 160))
    screen.blit(spr_nuclear, (WIDTH - 200, HEIGHT - 120))
    screen.blit(myfont.render("X " + str(active_player.nuclear), False, (0, 0, 0)), (WIDTH - 150, HEIGHT - 110))

    for i, player in enumerate(players):
        if i < 3:
            pg.draw.rect(screen, player.color, pg.Rect(WIDTH - 200 + 1.1*i*BUTTON_WIDTH, 20, BUTTON_WIDTH, BUTTON_HEIGHT)) #player selection boxes
            pg.draw.rect(screen, (0,0,0), pg.Rect(WIDTH - 200 + 1.1*i*BUTTON_WIDTH, 20, BUTTON_WIDTH, BUTTON_HEIGHT), 2)
        else:
            pg.draw.rect(screen, player.color, pg.Rect(WIDTH - 200 + 1.1*(i-3)*BUTTON_WIDTH, 20 + 1.2*BUTTON_HEIGHT, BUTTON_WIDTH, BUTTON_HEIGHT)) #player selection boxes
            pg.draw.rect(screen, (0,0,0), pg.Rect(WIDTH - 200 + 1.1*(i-3)*BUTTON_WIDTH, 20 + 1.2*BUTTON_HEIGHT, BUTTON_WIDTH, BUTTON_HEIGHT), 2)

    if shop:
            pg.draw.rect(screen, (170,230,170), pg.Rect(WIDTH - 900, HEIGHT - 600, 640, 560)) #background
            pg.draw.rect(screen, (0,0,0), pg.Rect(WIDTH - 900, HEIGHT - 600, 640, 560),3)
            #borders
            for i in range(3):
                pg.draw.rect(screen, (0,0,0), pg.Rect(WIDTH - 870 + 150*i, HEIGHT - 570, 130, 235), 3)
                pg.draw.rect(screen, card_background, pg.Rect(WIDTH - 870 + 150*i, HEIGHT - 570, 130, 235))
            for i in range(4):
                pg.draw.rect(screen, (0,0,0), pg.Rect(WIDTH - 870 + 150*i, HEIGHT - 315, 130, 235), 3)
                pg.draw.rect(screen, card_background, pg.Rect(WIDTH - 870 + 150*i, HEIGHT - 315, 130, 235))
