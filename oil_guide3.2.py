...
#directories
folder = "https://raw.githubusercontent.com/HugoNootebos/oil_guide/main/oil_guide3"
subfolder = "oil_img"
spr_food = pg.image.load(BytesIO(requests.get(f"{folder}/{subfolder}/food.png").content))
spr_food.convert()
spr_troops = pg.image.load(BytesIO(requests.get(f"{folder}/{subfolder}/troops.png").content))
spr_troops.convert()
spr_wood = pg.image.load(BytesIO(requests.get(f"{folder}/{subfolder}/wood.png").content))
spr_wood.convert()
spr_oil = pg.image.load(BytesIO(requests.get(f"{folder}/{subfolder}/oil.png").content))
spr_oil.convert()
spr_steel = pg.image.load(BytesIO(requests.get(f"{folder}/{subfolder}/steel.png").content))
spr_steel.convert()
spr_nuclear = pg.image.load(BytesIO(requests.get(f"{folder}/{subfolder}/nuclear.png").content))
spr_nuclear.convert()
spr_shop = pg.image.load(BytesIO(requests.get(f"{folder}/{subfolder}/shop.png").content))
spr_shop.convert()
spr_bridge = pg.image.load(BytesIO(requests.get(f"{folder}/{subfolder}/bridge.png").content))
spr_bridge.convert()
spr_ship = pg.image.load(BytesIO(requests.get(f"{folder}/{subfolder}/ship.png").content))
spr_ship.convert()
spr_plane = pg.image.load(BytesIO(requests.get(f"{folder}/{subfolder}/plane.png").content))
spr_plane.convert()
spr_tank = pg.image.load(BytesIO(requests.get(f"{folder}/{subfolder}/tank.png").content))
spr_tank.convert()
spr_rails = pg.image.load(BytesIO(requests.get(f"{folder}/{subfolder}/rails.png").content))
spr_rails.convert()
spr_fort = pg.image.load(BytesIO(requests.get(f"{folder}/{subfolder}/fort.png").content))
spr_fort.convert()
spr_nuke = pg.image.load(BytesIO(requests.get(f"{folder}/{subfolder}/nuke.png").content))
spr_nuke.convert()
