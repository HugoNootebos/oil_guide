...
#directories
folder = "/Users/hnootebos/Desktop/11General/Code/oil_guide3" #CHANGE THIS DIRECTORY TO MATCH YOUR SAVED LOCATION
subfolder = "oil_img"
spr_food = pg.image.load(f"{folder}/{subfolder}/food.png")
spr_food.convert()
spr_troops = pg.image.load(f"{folder}/{subfolder}/troops.png")
spr_troops.convert()
spr_wood = pg.image.load(f"{folder}/{subfolder}/wood.png")
spr_wood.convert()
spr_oil = pg.image.load(f"{folder}/{subfolder}/oil.png")
spr_oil.convert()
spr_steel = pg.image.load(f"{folder}/{subfolder}/steel.png")
spr_steel.convert()
spr_nuclear = pg.image.load(f"{folder}/{subfolder}/nuclear.png")
spr_nuclear.convert()
spr_shop = pg.image.load(f"{folder}/{subfolder}/shop.png")
spr_shop.convert()
spr_bridge = pg.image.load(f"{folder}/{subfolder}/bridge.png")
spr_bridge.convert()
spr_ship = pg.image.load(f"{folder}/{subfolder}/ship.png")
spr_ship.convert()
spr_plane = pg.image.load(f"{folder}/{subfolder}/plane.png")
spr_plane.convert()
spr_tank = pg.image.load(f"{folder}/{subfolder}/tank.png")
spr_tank.convert()
spr_rails = pg.image.load(f"{folder}/{subfolder}/rails.png")
spr_rails.convert()
spr_fort = pg.image.load(f"{folder}/{subfolder}/fort.png")
spr_fort.convert()
spr_nuke = pg.image.load(f"{folder}/{subfolder}/nuke.png")
spr_nuke.convert()
